#!/usr/bin/env python3
"""
Update imports from pipeline.* to shared.pipeline.*
"""
...
# Import mappings
IMPORT_MAPPINGS = [
    (r'from pipeline\.', 'from shared.pipeline.'),
    (r'import pipeline\.', 'import shared.pipeline.'),
]
...
def main():
    ...
    print("🔄 Updating pipeline imports to shared.pipeline...\n")
    ...
    for py_file in python_files:
        # Skip this script itself after first run
        if py_file.name == "update_pipeline_imports.py":
            continue
    ...
    print("\n" + "="*80)
    print(f"✅ Pipeline import update complete!")
