...
description: Laser cleaning parameters for Willow
applications:
- laser cleaning
- surface preparation
machineSettings:
  powerRange:
    ...
    unit: W
    confidence: 90
    description: Optimal average power for Willow surface cleaning without charring
    min: 20
    max: 60
  wavelength:
    value: 1064
    unit: nm
    confidence: 88
    description: Near-IR wavelength for optimal absorption in wood cellulose and lignin
    min: null
    max: null
  spotSize:
    value: 100
  ...
  energyDensity:
    ...
    unit: J/cm²
    confidence: 86
    description: Fluence threshold for effective Willow surface cleaning
    min: 2.5
    max: 7.6
  overlapRatio:
    value: 50
