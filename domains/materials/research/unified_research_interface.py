...
class UnifiedResearchResult:
    ...
    def to_complete_frontmatter(self) -> Dict[str, Any]:
        ...
        # Initialize with category groups per frontmatter_template.yaml
        frontmatter = {
            'materialProperties': {
        ...
        # Add material properties to correct category groups
...
__all__ = ['UnifiedMaterialResearcher', 'UnifiedResearchResult']