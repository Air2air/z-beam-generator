...
# Phase 4: Caption Generation - 13 Complete Materials
# Generated: November 23, 2025
# Purpose: Generate captions for Phase 2 complete materials
...
SUCCESS_COUNT=0
FAILED_COUNT=0
LOG_FILE="batch_phase4_captions.log"
PROGRESS_FILE="batch_phase4_captions_progress.txt"

> "$LOG_FILE"
> "$PROGRESS_FILE"

echo -e "${BLUE}════════════════════════════════════════════════════════════════════════════════${NC}"
echo -e "${BLUE}📸 PHASE 4A: Caption Generation${NC}"
echo -e "${BLUE}════════════════════════════════════════════════════════════════════════════════${NC}"
echo ""
...
echo -e "${BLUE}📊 PHASE 4A COMPLETE${NC}" | tee -a "$LOG_FILE"
echo -e "${BLUE}════════════════════════════════════════════════════════════════════════════════${NC}" | tee -a "$LOG_FILE"
