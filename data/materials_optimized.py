...
def get_material_by_name_cached(material_name: str, _cache_key: int = 0) -> Optional[Dict]:
    """
    ...
    Args:
        ...
        _cache_key: Internal cache invalidation key (increment to clear)
...
def find_material_case_insensitive(material_name: str, materials_data: dict = None) -> Tuple[Optional[Dict], Optional[str]]:
    ...
    DEPRECATED: Use get_material_by_name_cached() instead for better performance.
...
def get_material_by_name(material_name, data=None):
    ...
    DEPRECATED: Use get_material_by_name_cached() for better performance.
