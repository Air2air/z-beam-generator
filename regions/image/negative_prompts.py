...
TEXT_ACCURACY_NEGATIVE_PROMPTS = [
    # Spelling and legibility issues - CRITICAL
    "misspelled words",
    "misspelling",
    "spelling errors",
    "typos",
    ...
    "jumbled text",
    "incoherent text",
    "unreadable text that should be readable",
    "illegible text that should be clear",
    "backwards text",
    "reversed text",
    "upside down text",
    "inverted text",
    "incorrect spelling on signs",
    "misspelled signs",
    "made-up words",
    "fake words",
    "invented words",
    ...
    "deformed letters",
    "distorted letters",
    "letters with wrong proportions",
    "letters with missing parts",
    "incomplete letters",
    "partial letters",
    "fragmented letters",
    "broken letter strokes",
    "disconnected letter parts",
    "letters missing serifs",
    "letters missing stems",
    "letters missing bowls",
    ...
    "broken letters",
    "shattered letters",
    "text that bleeds together",
    "overlapping letters that shouldn't overlap",
    ...
    "floating letter parts",
    "detached letter segments",
    "asymmetric letters that should be symmetric",
    "lopsided letters",
    "tilted letters that shouldn't be tilted",
    
    # Inappropriate signage
    "modern fonts",
    "digital fonts",
    "computer fonts",
    "sans-serif fonts that look too modern",
    "modern brand logos",
    "contemporary corporate branding",
    "QR codes",
    "barcodes",
    "modern business signs",
    "LED signage",
    "digital displays",
    "electronic signs",
    "backlit signs with modern appearance",
    "plastic signs",
    "vinyl banners",
    "printed banners with modern look",
    
    # Text rendering failures - CRITICAL
    "text with incorrect letters",
    "words spelled wrong",
    "business names misspelled",
    "sign text with errors",
    "improperly formed text",
    "badly rendered letters",
    "AI-garbled text",
    ...
    "unreadable business names",
    "signs with nonsense text",
    "fake-looking text",
    "artificial-looking letters",
    "letters that don't look real",
    "text that looks computer-generated badly",
    "poorly rendered typography",
...
PHOTO_QUALITY_NEGATIVE_PROMPTS = [
    ...
    "vibrant colors",
    "digital color",
    "modern color processing",
    "color grading that looks modern",
    "color tinting",
    "hand-tinted",
