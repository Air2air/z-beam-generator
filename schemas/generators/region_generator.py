...
Parses region schema definition and delegates to specialized generators
"""
...
class RegionGenerator:
    """
    Generator for region articles that delegates to specialized generators
    ...
    def _load_schema_definition(self) -> Dict[str, Any]:
        """
        Load region schema definition
        """
        schema_path = os.path.join(
            "schemas", "definitions", "region_schema_definition.md"
        )
        ...
        with open(schema_path, 'r', encoding='utf-8') as f:
            ...
            self.logger.info(f"Loaded region schema definition")
            return schema_definition
    
    def generate(self, context: Dict[str, Any]) -> Dict[str, Any]:
        """
        Generate region article and delegate specialized parts
        NO defaults or fallbacks - schema is the only source of truth
        """
        self.logger.info(f"Generating region article for: {context['subject']}")
