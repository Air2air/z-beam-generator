...
class MockAPIClient:
        ...
        self.provider_configs = {
            "deepseek": {
                ...
                "component_optimizations": {
                    "frontmatter": {"max_tokens": 4000, "temperature": 0.1},
                    "content": {"max_tokens": 4000, "temperature": 0.1},
                    "jsonld": {"max_tokens": 4000, "temperature": 0.1},
                    "table": {"max_tokens": 4000, "temperature": 0.1},
                    "metatags": {"max_tokens": 4000, "temperature": 0.1},
                    "tags": {"max_tokens": 4000, "temperature": 0.1},
                    "bullets": {"max_tokens": 4000, "temperature": 0.1},
                    "caption": {"max_tokens": 4000, "temperature": 0.1},
                    "propertiestable": {"max_tokens": 4000, "temperature": 0.1},
                },
            },
            "grok": {
                "model": "grok-4",
    ...
    def _generate_content_from_prompt(self, prompt: str) -> str:
        ...
        # Material-specific content generation (using lowercase for case-insensitive matching)
        materials = {
...
The technology offers significant improvements over traditional cleaning methods, providing both economic and environmental benefits for industrial applications."""
    ...
    def _generate_generic_content(self) -> str:
        """Generate generic mock content for any prompt"""
        return """### Generic Mock Content Response

This is a mock response generated by the testing framework. In a real scenario, this would be replaced by actual AI-generated content based on the specific prompt and context provided.
...
The content generation process follows established protocols for creating accurate, informative, and contextually appropriate responses. This ensures consistency across different materials and applications.

### Quality Assurance
All generated content undergoes validation to ensure accuracy, completeness, and adherence to industry standards. This mock version maintains the structure and format expected by the application while providing predictable content for testing purposes."""
