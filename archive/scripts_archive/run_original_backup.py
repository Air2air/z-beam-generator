...
from api.client_manager import create_api_client, get_api_client_for_component, validate_api_environment, test_api_connectivity
...
from utils.file_operations import save_component_to_file, clean_content_components
from generators.workflow_manager import run_dynamic_generation, run_batch_generation, run_interactive_generation, run_material_generation
...
# Functions are now imported from modular components above
