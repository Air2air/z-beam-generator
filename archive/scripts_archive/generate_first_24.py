...
Uses the fail_fast_generator to create content for the first 24 materials
"""
    ...
    try:
        ...
        if result.success:
            ...
            if result.quality_score:
                ...
                print(
                    f"   👤 Human Believability: {result.quality_score.human_believability:.1f}/100"
                )
...
def main():
    ...
    generator = create_fail_fast_generator(
        max_retries=2, retry_delay=1.0, enable_scoring=True, human_threshold=70.0
    )
