...
class ConfigurationManager:
    ...
    def _load_persona_from_files(self, author_id: int) -> Dict[str, Any]:
        ...
        # Fail fast if no valid persona configuration found
        raise ValueError(f"No valid persona configuration found for author_id {author_id} - all required persona files must be available")
