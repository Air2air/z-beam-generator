...
"""
    ...
    def _extract_from_frontmatter(
        ...
        opengraph.append({"property": "og:image", "content": f"https://z-beam.com/images/material/{material_slug}-laser-cleaning-hero.jpg"})
        ...
        twitter.append({"name": "twitter:image", "content": f"https://z-beam.com/images/material/{material_slug}-laser-cleaning-hero.jpg"})
