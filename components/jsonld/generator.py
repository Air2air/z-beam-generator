...
from components.base.validation_utils import (
    validate_non_empty, validate_required_fields
)
from components.base.formatting_utils import format_jsonld_as_script
...
class JsonldGenerator(EnhancedBaseComponent):
    ...
    def _post_process(self, content: str) -> str:
        ...
        """
        content = validate_non_empty(content, "API returned empty or invalid JSON-LD")
        ...
        return format_jsonld_as_script(jsonld)
    ...
    def _validate_jsonld(self, jsonld: Dict[str, Any]) -> None:
        ...
        validate_required_fields(jsonld, required_fields, "JSON-LD")
