...
class JSONLDCalculator:
    ...
    def calculate_article_body(self) -> str:
        ...
        primary_apps = [
            app.get("detail", "industrial processing") for app in applications[:2]
        ]
    ...
    def _extract_contamination_types(self) -> str:
        ...
        return (
            ", ".join(contamination_types)
            if contamination_types
            else "surface contaminants"
        )
    ...
    def _generate_image_description(self, image_type: str) -> str:
        ...
        if image_type == "hero":
            return (
                f"High-resolution dual-panel photograph showing a {self.subject} component "
            ...
            return (
                f"Comparative scanning electron micrographs displaying surface microstructure "
    ...
    def generate_video_object(self) -> Dict[str, Any]:
        ...
        subject_slug = self._generate_slug(self.subject)
        wavelength = self.frontmatter.get("technicalSpecifications", {}).get(
            "wavelength", "1064nm"
        )
    ...
    def generate_complete_jsonld(self) -> Dict[str, Any]:
        ...
        jsonld = {
            ...
            "license": "https://creativecommons.org/licenses/by/4.0/",
            "copyrightHolder": {"@type": "Organization", "name": "Z-Beam Technologies"},
            ...
            "about": [
                {
                    ...
                    "name": self.subject,
                    "alternateName": [
                        self.frontmatter.get("chemicalProperties", {}).get(
                            "formula", ""
                        ),
                        self.frontmatter.get("chemicalProperties", {}).get(
                            "symbol", ""
                    ...
                    "identifier": self.frontmatter.get("chemicalProperties", {}).get(
                        "symbol", ""
                    ),
                    "category": self.category,
                    "description": self.frontmatter.get(
                        "description", f"{self.subject} material for laser processing"
                    ),
            ...
            "mentions": [
                app.get("industry", "")
                for app in self.frontmatter.get("applications", [])[:3]
            ],
