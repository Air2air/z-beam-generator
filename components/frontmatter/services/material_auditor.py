...
MIGRATION NOTE: Update your imports to use:
    from services.property.material_auditor import MaterialAuditor

This redirect will be removed in a future release.
"""

# Redirect to canonical implementation
from services.property.material_auditor import *

# Deprecated warning
import warnings
warnings.warn(
    "Importing from components.frontmatter.services.material_auditor is deprecated. "
    "Use 'from services.property.material_auditor import MaterialAuditor' instead.",
    DeprecationWarning,
    stacklevel=2
)
