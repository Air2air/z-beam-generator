...
class TestSiliconNitrideCaseStudy:
    ...
    def test_taiwan_persona_file_structure(self):
        ...
        for phrase in expected_phrases:
            assert phrase in signature_phrases, f"Expected signature phrase '{phrase}' not found"

    def test_taiwan_formatting_file_structure(self):
        """Verify Taiwan formatting file contains expected structure from case study."""
        formatting_file = Path("components/text/prompts/formatting/taiwan_formatting.yaml")
    ...
    def test_case_study_content_structure(self, case_study_content):
        ...
        assert "### A Practical Look at Laser Cleaning Silicon Nitride" in case_study_content
    ...
    def test_prompt_chain_taiwan_integration(self, generator):
        ...
        prompt = generator._build_api_prompt(subject, author_id, author_name, material_data, author_info)
        ...
        signature_indicators = ["This is important, very important", "It works good, really good"]
    ...
    def test_configuration_optimization_tracking(self, case_study_content):
        ...
        assert "optimization_method: \"iterative_config_modification\"" in case_study_content
    ...
    def test_technical_content_accuracy(self, case_study_content):
        ...
        for term in technical_terms:
            assert term in content_lower, f"Technical term '{term}' not found in content"
