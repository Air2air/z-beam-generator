...
from optimizer.ai_detection.service import AIDetectionResult, AIDetectionService
...
class FrontmatterAIDetector:
    ...
    def update_frontmatter_with_ai_detection(self, file_path: str) -> bool:
        ...
        try:
            ...
            frontmatter["ai_detection_analysis"] = self._build_ai_detection_section(
                ai_result
            )
            ...
            frontmatter["quality_metrics"].update(
                self._build_quality_metrics_update(ai_result)
            )
    ...
    def _build_ai_detection_section(
        self, ai_result: AIDetectionResult
    ) -> Dict[str, Any]:
    ...
    def _build_quality_metrics_update(
        self, ai_result: AIDetectionResult
    ) -> Dict[str, Any]:
    ...
    def update_all_text_components(
        self, directory: str = "content/components/text"
    ) -> Dict[str, int]:
