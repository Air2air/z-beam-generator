...
def calculate_percentile(
    value: Union[str, float], min_value: Union[str, float], max_value: Union[str, float]
) -> float:
    """
...
def calculate_property_percentiles(
    properties: dict, category_ranges: dict, category: str
) -> dict:
    """
    ...
    property_mappings = [
        ...
        (
            "laserReflectivity",
            "laserReflectivityMin",
            "laserReflectivityMax",
            "laserReflectivityPercentile",
        ),
        (
            "thermalDiffusivity",
            "thermalDiffusivityMin",
            "thermalDiffusivityMax",
    ...
    for value_key, min_key, max_key, percentile_key in property_mappings:
        ...
        if value_key in properties and min_key in properties and max_key in properties:
...
if __name__ == "__main__":
    ...
    for value, min_val, max_val, expected in percentile_tests:
        ...
        print(
            f"  {value} in range [{min_val}, {max_val}] = {result}% (expected: {expected}%)"
        )
