...
Automated property classification based on property_definitions.yaml registry.
Eliminates manual classification, reduces errors, ensures consistency.

Usage:
    from utils.property_classifier import PropertyClassifier
...
class PropertyClassifier:
    ...
    def __init__(self, registry_path: Optional[Path] = None):
        ...
        Args:
            registry_path: Path to property_definitions.yaml (auto-detects if None)
        """
        ...
        self.properties = self.registry.get('properties', {})
        self.rules = self.registry.get('classification_rules', {})
        self.mappings = self.registry.get('legacy_property_mappings', {})
