...
def enhance_frontmatter_with_context(frontmatter_data: Dict[str, Any], category: str) -> Dict[str, Any]:
    ...
    logger.info(f"Enhanced frontmatter for {category} category with min/max context and percentiles")
    return frontmatter_data
    ...
    try:
        ...
        if content.startswith('---'):
            ...
            if len(parts) >= 2:
                ...
                enhanced_yaml = yaml.dump(enhanced_data, default_flow_style=False, sort_keys=False, allow_unicode=True)
