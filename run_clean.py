...
from utils.file_operations import load_component_from_file, save_component_to_file
...
def main():
    ...
    parser.add_argument("--material", help="Material name for optimization (optional - optimizes all if not specified)")
