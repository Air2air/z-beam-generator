...
- **Location**: `parameters/variation/sentence_rhythm_variation.py`
...
- **Location**: `parameters/variation/imperfection_tolerance.py`
...
- **Location**: `parameters/voice/jargon_removal.py`
...
- **Location**: `parameters/voice/professional_voice.py`
...
- **Location**: `parameters/voice/author_voice_intensity.py`
...
- **Location**: `parameters/voice/personality_intensity.py`
...
- **Location**: `parameters/voice/engagement_style.py`
...
- **Location**: `parameters/voice/emotional_intensity.py`
...
- **Location**: `parameters/technical/technical_language_intensity.py`
...
- **Location**: `parameters/technical/context_specificity.py`
...
- **Location**: `parameters/variation/structural_predictability.py`
...
- **Location**: `parameters/variation/length_variation_range.py`
...
- **Location**: `parameters/ai_detection/ai_avoidance_intensity.py`
...
- **Location**: `parameters/ai_detection/humanness_intensity.py`
...
- **Files**: `shared/voice/profiles/*.yaml`
...
- `parameters/README.md` - Implementation details
