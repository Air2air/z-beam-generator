...
→ `.github/copilot-instructions.md` (comprehensive rules)  
→ `GROK_QUICK_REF.md` (critical policies, tier priorities)
...
- `copilot-instructions.md` - Comprehensive rules and guidelines (1398 lines)
