...
**Flow**:
```
1. Generate domain_linkages from associations
...
if existing_file_exists:
    frontmatter['domain_linkages']['produces_compounds'] = existing_data
...
- Single source of truth: domain_linkages.produces_compounds
