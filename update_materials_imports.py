#!/usr/bin/env python3
"""
Update imports from data.materials to materials.data.materials
"""
...
# Import mappings
IMPORT_MAPPINGS = [
    (r'from data\.materials import', 'from materials.data.materials import'),
    (r'import data\.materials', 'import materials.data.materials'),
]
...
def main():
    ...
    print("🔄 Updating materials imports to materials.data.materials...\n")
    ...
    for py_file in python_files:
        ...
        if py_file.name == "update_materials_imports.py":
            continue
    ...
    print("\n" + "="*80)
    print("✅ Materials import update complete!")
