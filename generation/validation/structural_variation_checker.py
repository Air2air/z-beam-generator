...
class StructuralVariationChecker:
    ...
    def _load_author_signature(self, author_id: int) -> Dict:
        ...
        author_files = {
            2: 'domains/materials/prompts/personas/italy.yaml',
            3: 'domains/materials/prompts/personas/taiwan.yaml',
            4: 'domains/materials/prompts/personas/united_states.yaml'
        }
