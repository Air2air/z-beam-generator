...
class StreamlinedFrontmatterGenerator(APIComponentGenerator):
    ...
    def __init__(self, api_client=None, config=None, **kwargs):
        ...
        try:
            from export.prompts.industry_applications import IndustryApplicationsPromptBuilder
            from export.prompts.regulatory_standards import RegulatoryStandardsPromptBuilder
            from export.prompts.environmental_impact import EnvironmentalImpactPromptBuilder
