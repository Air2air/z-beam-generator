...
try:
    from export.tests.test_streamlined_generator import TestStreamlinedGenerator, TestStreamlinedGeneratorEdgeCases
except ImportError:
    # Fallback to existing tests if new ones don't exist yet
    from export.tests.test_core_generator import TestCoreGenerator as TestStreamlinedGenerator, TestGeneratorEdgeCases as TestStreamlinedGeneratorEdgeCases

from export.tests.test_field_ordering import TestFieldOrderingService

try:
    # Property enhancement tests (2 test classes)
    from export.tests.test_unified_property_enhancement import TestPropertyEnhancementService, TestPropertyEnhancementEdgeCases
except ImportError:
    # Fallback to existing tests if new ones don't exist yet
    from export.tests.test_property_enhancement import TestPropertyEnhancementService, TestPropertyEnhancementEdgeCases

from export.tests.test_validation_helpers import TestValidationHelpers, TestValidationHelpersEdgeCases
from export.tests.test_integration import TestFrontmatterIntegration, TestPropertyEnhancementIntegration
