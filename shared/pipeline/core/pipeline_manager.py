...
class PipelineManager:
    ...
    def _execute_text_generation(self, material: str, **kwargs) -> Dict[str, Any]:
        ...
        from shared.pipeline.modes.text_generator import TextGenerator
    ...
    def _execute_data_research(self, material: str, **kwargs) -> Dict[str, Any]:
        ...
        from shared.pipeline.modes.data_researcher import DataResearcher
    ...
    def _execute_frontmatter_output(
        ...
        **kwargs
        ...
        from shared.pipeline.modes.frontmatter_output import FrontmatterOutput
