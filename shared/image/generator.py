...
Architecture:
- Universal generation logic (works for all domains)
- Domain-specific prompt templates (content strategy in text files)
- Domain data access (materials, contaminants, applications, regions)
- Shared validation and optimization
...
class MaterialsDataLoader:
    ...
    def load(self, material_name: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'surface_finish': material_data.get('surface_finish', 'Unknown'),
            'reflectivity': material_data.get('reflectivity', 'Unknown'),
            'color': material_data.get('color', 'Unknown')
        }
